...
type = "ACTIVE"
table = "ACTIVE.ORGANIZATIONS_US_ACTIVE"
csv_file_name = "organizations_us_active.csv"
...
dag = DAG(
    "PIPDRIVE_ETL_ORGANIZATIONS_US_ACTIVE",
    description="PIPDRIVE_ETL_ORGANIZATIONS_US_ACTIVE",
