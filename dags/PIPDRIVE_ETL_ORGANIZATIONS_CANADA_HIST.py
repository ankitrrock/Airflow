...
type = "HIST"
table = "HISTORICAL.ORGANIZATIONS_CANADA_HIST"
csv_file_name = "organizations_canada_hist.csv"
...
dag = DAG(
    "PIPEDRIVE_ETL_ORGANIZATIONS_CANADA_HIST",
    description="PIPEDRIVE_ETL_ORGANIZATIONS_CANADA_HIST",
