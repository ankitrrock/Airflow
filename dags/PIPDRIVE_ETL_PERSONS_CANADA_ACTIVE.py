...
type = "ACTIVE"
table = "ACTIVE.PERSONS_CANADA_ACTIVE"
csv_file_name = "persons_canada_active.csv"
...
dag = DAG(
    "PIPDRIVE_ETL_PERSONS_CANADA_ACTIVE",
    description="PIPDRIVE_ETL_PERSONS_CANADA_ACTIVE",
