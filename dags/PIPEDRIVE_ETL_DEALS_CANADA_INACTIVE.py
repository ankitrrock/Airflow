...
type = "INACTIVE"
table = "INACTIVE.DEALS_CANADA_INACTIVE"
...
dag = DAG(
    "PIPEDRIVE_ETL_DEALS_CANADA_INACTIVE",
    description="PIPEDRIVE_ETL_DEALS_CANADA_INACTIVE",
