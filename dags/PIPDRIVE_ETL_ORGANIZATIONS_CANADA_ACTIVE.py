...
type = "ACTIVE"
table = "ACTIVE.ORGANIZATIONS_CANADA_ACTIVE"
csv_file_name = "organizations_canada_active.csv"
...
dag = DAG(
    "PIPDRIVE_ETL_ORGANIZATIONS_CANADA_ACTIVE",
    description="PIPDRIVE_ETL_ORGANIZATIONS_CANADA_ACTIVE",
...
def read_config():
    ...
    final_etl = set_etl(data_for_etl, streams_statusid="ORGANIZATIONS_CANADA")
