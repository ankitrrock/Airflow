...
dag = DAG('NCS_DW_EXTRACT_PE'
          ,description='NCS_DW_EXTRACT_PE'
...
def extraction_start():
    abc = glob.glob(Variable.get("PE_DECRYPT_PATH_HIST") + "*")
    if len(abc) > 0:
        ...
        print(zip_path)
        shutil.make_archive(zip_path, 'zip', Variable.get("PE_DECRYPT_PATH_HIST"))
        for x in abc:
            os.remove(x)

    BATCH_NAME = "NCS_DW_EXTRACT_PE"
    ...
    KCA_CFG_BATCH_PARAM.to_excel(
        "/home/oodles/ncs_multistage/export/home/dwhadminuser/bip_ucm_home/ucm/pe_files/excel_files/KCA_CFG_BATCH_PARAM.xlsx", index=False)

    KCA_CTRL_BATCH = pd.read_sql(
        "select * from NCS_MDADM.KCA_CTRL_BATCH where BATCH_NAME='NCS_DW_EXTRACT_PE' ORDER BY BATCH_START_DATE DESC LIMIT 1",
        con)
    KCA_CTRL_BATCH.to_excel("/home/oodles/ncs_multistage/export/home/dwhadminuser/bip_ucm_home/ucm/pe_files/excel_files/KCA_CTRL_BATCH_PE.xlsx",
                            index=False)
    ...
    data1 = pd.read_excel("/home/oodles/ncs_multistage/export/home/dwhadminuser/bip_ucm_home/ucm/pe_files/excel_files/data.xlsx")
...
def extraction_complete():
    ...
    # Inserting the running record into batch table to log the batch details
    cur.execute(
        "update NCS_MDADM.KCA_CTRL_BATCH set BATCH_STATUS='COMPLETED',BATCH_END_DATE=current_timestamp::timestamp_ntz WHERE BATCH_NAME='NCS_DW_EXTRACT_PE' AND BATCH_ID=(select MAX(BATCH_ID) from NCS_MDADM.KCA_CTRL_BATCH);")
...
en_path = str(Variable.get('PE_ENCRYPT_PATH_HIST'))
de_path = str(Variable.get('PE_DECRYPT_PATH_HIST'))
...
x="/home/oodles/ncs_multistage/export/home/dwhadminuser/bip_ucm_home/ucm/pe_files/excel_files/KCA_ERP_TABLE_ROW_CNT.xlsx"
bulk_file=[]
...
PE_files = pd.read_excel("/home/oodles/ncs_multistage/export/home/dwhadminuser/bip_ucm_home/ucm/pe_files/excel_files/PE_data.xlsx")
...
trigger_dag_ncs_dw_load_pe =TriggerDagRunOperator(task_id="trigger_ncs_dw_load_pe",trigger_dag_id="NCS_DW_LOAD_PE",dag=dag)
...
dummy[n] >> bip_success >> ucm_start >> ucm1 >> ucm_success >> extraction_complete >> trigger_dag_ncs_dw_load_pe >> batch_error
...
df2 = pd.read_excel("/home/oodles/ncs_multistage/export/home/dwhadminuser/bip_ucm_home/ucm/pe_files/excel_files/KCA_ERP_TABLE_ROW_CNT.xlsx")
