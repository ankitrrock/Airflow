...
type = "HIST"
table = "HISTORICAL.PRODUCTS_CANADA_HIST"
csv_file_name = "products_canada_hist.csv"
...
dag = DAG(
    "PIPEDRIVE_ETL_PRODUCTS_CANADA_HIST",
    description="PIPEDRIVE_ETL_PRODUCTS_CANADA_HIST",
