...
type = "INACTIVE"
table = "INACTIVE.PERSONS_US_INACTIVE"
csv_file_name = "deals_us_inactive.csv"
...
dag = DAG(
    "PIPEDRIVE_ETL_PERSONS_US_INACTIVE",
    description="PIPEDRIVE_ETL_PERSONS_US_INACTIVE",
...
def read_config():
    ...
    final_etl = set_etl(data_for_etl, streams_statusid="PERSONS_US")
