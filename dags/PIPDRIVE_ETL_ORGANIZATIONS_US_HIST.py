...
type = "HIST"
table = "HISTORICAL.ORGANIZATIONS_US_HIST"
csv_file_name = "organizations_us_hist.csv"
...
dag = DAG(
    "PIPEDRIVE_ETL_ORGANIZATIONS_US_HIST",
    description="PIPEDRIVE_ETL_ORGANIZATIONS_US_HIST",
