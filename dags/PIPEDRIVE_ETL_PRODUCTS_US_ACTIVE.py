...
type = "ACTIVE"
table = "ACTIVE.PRODUCTS_US_ACTIVE"
csv_file_name = "products_us_active.csv"
...
dag = DAG(
    "PIPEDRIVE_ETL_PRODUCTS_US_ACTIVE",
    description="PIPEDRIVE_ETL_PRODUCTS_US_ACTIVE",
...
def read_config():
    ...
    final_etl = set_etl(data_for_etl, streams_statusid="PRODUCTS_US")
